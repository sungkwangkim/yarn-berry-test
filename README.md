...
- 여러 개의 개별 프로젝트를, **잘 정의된 관계**를 통해서 하나의 Repo에 담은 것
...
- yarn berry
- **turoborepo**
  - yarn berry로 환경을 구축해봐야 turborepo의 간편함과 심플함을 알 수 있었다.

## Monorepo 공통 코드 사용해보기
...
### 조직간 원칙과 R&R 아닌, 동료들과 상호작용과 성장으로
...
- 일반화된 개발환경 제공으로 엔지니어들의 업무변경 발생시 적용시간이 대폭 감소 시킬 수 있다.

** --> 엔지니어가 신규프로젝트 생성시 테스트, 빌드, 배포 파이브라인에 드는 에너지를 줄일수록 "더 좋은 유저 경험과 비지니스 모델에" 깊이 고민 할수 있는 에너지가 생기게 됩니다.**

### 지속 가능한 환경

- 브레이킹 체인지에 대한 빠른 감지로 대규모 리펙토링이 가능하다.
- 또한, 프레임워크 버전 업그레이드의 동기부여가 되기도 한다.
